...
const clientId = '';
const clientSecret = '';
var tokenTeste = 'BQBF6dYa0Whz98JAlBg9rmfYWxw17aYkXhp5rTLsH_NdEXDSJtQB_WY-q6g2RiitwMmNdDhw4_F9dMIxzNE';


var pegaToken = (function () {
    fetch('https://accounts.spotify.com/api/token', {
        ...
        .then(token => {
            ...
            novoToken = token.access_token
            spotifyApi.setAccessToken(novoToken);
            return novoToken
        })
...
spotifyApi.getArtists(['2hazSY4Ef3aB9ATXW7F5w3', '6J6yx1t3nwIDyPXk5xa7O8']).then(
    function (data) {
